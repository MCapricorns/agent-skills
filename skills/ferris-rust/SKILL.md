...
6. **Windows API and FFI work follows the ferris-windows-dev skill** — it owns the Win32 correctness, FFI declaration, and DLL-boundary rules. Load it alongside this one; its rules are deliberately not restated here.
